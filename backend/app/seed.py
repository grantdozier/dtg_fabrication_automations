...
def seed_database(db: Session):
    ...
    # Part 1: Simple aluminum bracket
    part1 = models.Part(
    ...
    part1.operations = [
        models.Operation(name="Mill Op 10 - Face & Rough", sequence=10, machine_id=machines[0].id,
                        setup_time_hr=1.5, cycle_time_hr=0.25, allowance_pct=0.10),
        models.Operation(name="Mill Op 20 - Finish & Drill", sequence=20, machine_id=machines[0].id,
                        setup_time_hr=0.5, cycle_time_hr=0.15, allowance_pct=0.08),
        models.Operation(name="Deburr & Inspect", sequence=30, machine_id=machines[0].id,
                        setup_time_hr=0.25, cycle_time_hr=0.08, allowance_pct=0.05),
    ]
